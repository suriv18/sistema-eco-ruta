...
import pe.edu.unmsm.ciudadsana.rutas.application.port.in.CancelarRutaUseCase;
...
@Component
public class CancelarRutaCommandHandler implements CancelarRutaUseCase {

    private final RutasPersistencePort rutasPersistencePort;
    private final RutasEventPublisherPort eventPublisher;

    public CancelarRutaCommandHandler(RutasPersistencePort rutasPersistencePort,
    ...
    @Override
    public Result<RutaResponseDto> cancelar(CancelarRutaCommand cmd) {
