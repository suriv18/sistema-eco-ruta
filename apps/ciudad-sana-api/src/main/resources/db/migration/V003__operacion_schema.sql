...
CREATE TABLE IF NOT EXISTS operacion.distrito (
    distrito_id    UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS operacion.zona (
    ...
    creado_en           TIMESTAMPTZ NOT NULL DEFAULT now(),
    actualizado_en      TIMESTAMPTZ,
    CONSTRAINT fk_operacion_zona_distrito FOREIGN KEY (distrito_id) REFERENCES operacion.distrito(distrito_id),
...
CREATE TABLE IF NOT EXISTS operacion.deposito (
    ...
    creado_en      TIMESTAMPTZ NOT NULL DEFAULT now(),
    actualizado_en TIMESTAMPTZ,
    CONSTRAINT fk_operacion_deposito_distrito FOREIGN KEY (distrito_id) REFERENCES operacion.distrito(distrito_id),
...
CREATE TABLE IF NOT EXISTS operacion.contenedor (
    contenedor_id     UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    tenant_id         UUID NOT NULL,
    ...
    creado_en         TIMESTAMPTZ NOT NULL DEFAULT now(),
    actualizado_en    TIMESTAMPTZ,
    CONSTRAINT fk_operacion_contenedor_zona FOREIGN KEY (zona_id) REFERENCES operacion.zona(zona_id),
...
CREATE TABLE IF NOT EXISTS operacion.turno (
    ...
    creado_en      TIMESTAMPTZ NOT NULL DEFAULT now(),
    actualizado_en TIMESTAMPTZ,
    CONSTRAINT fk_operacion_turno_unidad FOREIGN KEY (unidad_id) REFERENCES operacion.unidad(unidad_id),
    CONSTRAINT fk_operacion_turno_chofer FOREIGN KEY (chofer_id) REFERENCES operacion.chofer(chofer_id),
    CONSTRAINT fk_operacion_turno_distrito FOREIGN KEY (distrito_id) REFERENCES operacion.distrito(distrito_id),
...
CREATE TABLE IF NOT EXISTS operacion.ruta (
    ...
    creado_en           TIMESTAMPTZ NOT NULL DEFAULT now(),
    actualizado_en      TIMESTAMPTZ,
    CONSTRAINT fk_operacion_ruta_turno FOREIGN KEY (turno_id) REFERENCES operacion.turno(turno_id),
    CONSTRAINT fk_operacion_ruta_distrito FOREIGN KEY (distrito_id) REFERENCES operacion.distrito(distrito_id),
    CONSTRAINT fk_operacion_ruta_deposito_origen FOREIGN KEY (deposito_origen_id) REFERENCES operacion.deposito(deposito_id),
    CONSTRAINT fk_operacion_ruta_deposito_destino FOREIGN KEY (deposito_destino_id) REFERENCES operacion.deposito(deposito_id),
...
CREATE TABLE IF NOT EXISTS operacion.ruta_version (
    ruta_version_id   UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    ...
    geometria         GEOMETRY(LINESTRING, 4326),
    creado_en         TIMESTAMPTZ NOT NULL DEFAULT now(),
    CONSTRAINT fk_operacion_ruta_version_ruta FOREIGN KEY (ruta_id) REFERENCES operacion.ruta(ruta_id),
...
CREATE TABLE IF NOT EXISTS operacion.ruta_parada (
    ruta_parada_id      UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    ...
    creado_en           TIMESTAMPTZ NOT NULL DEFAULT now(),
    actualizado_en      TIMESTAMPTZ,
    CONSTRAINT fk_operacion_ruta_parada_version FOREIGN KEY (ruta_version_id) REFERENCES operacion.ruta_version(ruta_version_id),
    CONSTRAINT fk_operacion_ruta_parada_zona FOREIGN KEY (zona_id) REFERENCES operacion.zona(zona_id),
    CONSTRAINT fk_operacion_ruta_parada_contenedor FOREIGN KEY (contenedor_id) REFERENCES operacion.contenedor(contenedor_id),
...
CREATE TABLE IF NOT EXISTS operacion.ruta_evento (
    ruta_evento_id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    ruta_id        UUID NOT NULL,
    ...
    datos          JSONB,
    creado_en      TIMESTAMPTZ NOT NULL DEFAULT now(),
    CONSTRAINT fk_operacion_ruta_evento_ruta FOREIGN KEY (ruta_id) REFERENCES operacion.ruta(ruta_id),
...
CREATE TABLE IF NOT EXISTS operacion.horario_recoleccion (
    ...
    creado_en      TIMESTAMPTZ NOT NULL DEFAULT now(),
    actualizado_en TIMESTAMPTZ,
    CONSTRAINT fk_operacion_horario_zona FOREIGN KEY (zona_id) REFERENCES operacion.zona(zona_id),
