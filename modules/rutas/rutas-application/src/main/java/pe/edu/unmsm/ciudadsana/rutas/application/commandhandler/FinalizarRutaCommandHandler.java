...
import pe.edu.unmsm.ciudadsana.rutas.application.port.in.FinalizarRutaUseCase;
...
@Component
public class FinalizarRutaCommandHandler implements FinalizarRutaUseCase {

    private final RutasPersistencePort rutasPersistencePort;
    private final RutasEventPublisherPort eventPublisher;

    public FinalizarRutaCommandHandler(RutasPersistencePort rutasPersistencePort,
    ...
    @Override
    public Result<RutaResponseDto> finalizar(FinalizarRutaCommand cmd) {
