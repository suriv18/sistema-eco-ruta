...
import pe.edu.unmsm.ciudadsana.rutas.application.port.in.IniciarEjecucionRutaUseCase;
...
@Component
public class IniciarEjecucionRutaCommandHandler implements IniciarEjecucionRutaUseCase {

    private final RutasPersistencePort rutasPersistencePort;
    private final RutasEventPublisherPort eventPublisher;

    public IniciarEjecucionRutaCommandHandler(RutasPersistencePort rutasPersistencePort,
    ...
    @Override
    public Result<RutaResponseDto> iniciarEjecucion(IniciarEjecucionRutaCommand cmd) {
